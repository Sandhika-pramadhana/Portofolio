    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 md:py-24">
        <section className="mx-auto max-w-4xl">
          ...
          {/* Pagination */}
          <div className="mt-14 flex flex-col gap-4 border-t border-neutral-200 pt-8 md:flex-row md:items-center md:justify-between fade-up">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                disabled={page === 1}
                className="rounded-full border border-neutral-200 px-4 py-2 text-sm font-medium text-neutral-600 disabled:opacity-40"
              >
                Prev
              </button>
